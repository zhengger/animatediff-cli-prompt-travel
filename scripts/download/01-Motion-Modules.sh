...
wget https://civitai.com/api/download/models/159987 -P /content/animatediff-cli-prompt-travel/data/models/motion-module --content-disposition --no-check-certificate
